...
MODEL_NAME = '/home/ashish/Anomoly-detection/Image-forgery-detection/model/Image-Forgery-{}.model'.format('CNN')
...
def run(imgPath):
    newPath = aadhar_extraction_temp.runTest(imgPath)
...
path2 = '/home/ashish/Anomoly-detection/Image-forgery-detection/dataset/Testdataset/test.10.jpg'
run(path2)
