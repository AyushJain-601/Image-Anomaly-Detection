...
targetDIR = "/home/ashish/Anomoly-detection/Image-forgery-detection/dataset/extracteddataset/"
from tqdm import tqdm
PATH_TO_TEST_IMAGES_DIR = '/home/ashish/Anomoly-detection/Image-forgery-detection/dataset/pos/'
temp= []
...
with detection_graph.as_default():
  	with tf.Session(graph=detection_graph) as sess:
	    ...
	    for image_path in TEST_IMAGE_PATHS:
	      ...
	      im.save(Tagetpath[i], 'JPEG')
	      # cv2.imwrite(Tagetpath[i],Result)
	      i+=1
cv2.waitKey(0)
