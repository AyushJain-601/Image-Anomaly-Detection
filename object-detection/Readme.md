1. Generating Dataset
	* Save all the training images in the "/home/ashish/Anomoly-detection/object-detection/object_detection/Images/train" directory
	* Save all the validation images in the "/home/ashish/Anomoly-detection/object-detection/object_detection/Images/test" directory
...
2. Generate labelmap.pbtxt file containing no. of categories check "/home/ashish/object-detection/object_detection/training/labelmap.pbtxt"
...
3. Configure Model
	...
	* Configure ".config" file of the model by making following changes: 
		...
		- "fine_tune_checkpoint:" path to model in our case "/home/ashish/object-detection/object_detection/training/faster_rcnn_inception_v2_coco"
		- inside "train_input_reader:" function
			* change "input_path:" path to "train.record" file in our case "/home/ashish/object-detection/object_detection/Images/train.record"
			*  change "label_map_path:" path to "labelmap.pbtxt" file in our case "/home/ashish/object-detection/object_detection/training/labelmap.pbtxt"
		- inside "eval_input_reader:" function 
			*change "input_path:" path to "test.record" file in our case "/home/ashish/object-detection/object_detection/Images/test.record"
			* change "label_map_path:" path to "labelmap.pbtxt" file in our case "/home/ashish/object-detection/object_detection/training/labelmap.pbtxt"
		- save the changes
