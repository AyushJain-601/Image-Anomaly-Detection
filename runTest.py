...
MODEL_NAME = '/home/ashish/Anomoly-detection/Image-forgery-detection/model2/Image-Forgery-{}.model'.format('CNN')


#Function to convert images to their ELA form so that the CNN can be trained on these ELA images
def convert_ela(img,path,qual):
    filename = path
...
def run(imgPath):
    ...
    elaImg = convert_ela(img,newPath, 90)
